...
{
  private static String  _id = "IDL:HomeHub/Log:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = HomeHub.AlarmHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (HomeHub.LogHelper.id (), "Log", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    HomeHub.Alarm value[] = null;
    int _len0 = istream.read_long ();
    value = new HomeHub.Alarm[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = HomeHub.AlarmHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, HomeHub.Alarm[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      HomeHub.AlarmHelper.write (ostream, value[_i0]);
  }
